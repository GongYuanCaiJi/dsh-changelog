...
import { PROMPT_SPECS, renderPrompt } from './prompts.js';
...
export function deliverPrompt(invocation: CommandInvocation, commandName: string, rawInput: string): CommandResult {
