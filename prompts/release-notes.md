...
Follow `.dsh/release-notes-style.md` when present. Otherwise write only a plain Markdown bullet list of specific public summaries, with no heading, intro, version line, emoji, CTA, links, or social framing.
...
Write source review details only to `.dsh/tmp/pi-changelog/release-notes-sources/<slug>.md` in this format:
