...
2. If `.dsh/release-notes-style.md` exists, refine it without replacing useful guidance.
3. Create `.dsh/` if needed.
4. Write `.dsh/release-notes-style.md`.
